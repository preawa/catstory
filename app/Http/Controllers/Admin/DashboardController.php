...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // $catowners = Catowner::all();
        // $total_pending_catowners = Catowner::where('is_approved', false)->count();
        // $author_count = User::where('role_id', 2)->count();
        // return view('admin.dashboard', compact('catowners', 'total_pending_catowners', 'author_count'));
    }
}
