...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            <a class="btn btn-primary waves-effect" href="{{ route('admin.form.create') }}">
                                    ...
                                    @foreach ($forms as $key => $form)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.form.show', $form->id) }}"
                                                    class="btn btn-success waves-effect">
                                                    <i class="material-icons">visibility</i>
                                                </a>
                                                <a href="{{ route('admin.form.edit',$form->id) }}" class="btn btn-info waves-effect">
                                                ...
                                                <form id="delete-form-{{ $form->id }}"
                                                    action="{{ route('admin.form.destroy', $form->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
