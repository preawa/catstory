        ...
        <div class="container">
            ...
            <div class="widget widget-tabbed ">
                ...
                <ul
                    ...
                    <li class="nav-item">
                        <a class="nav-link py-4" href="{{ route('map1') }}">แมวมีเจ้าของ</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link py-4 active" href="{{ route('map2') }}">แมวไม่มีเจ้าของ</a>
                    </li>
                </ul>
                <!-- End nav tab -->
                ...
                <div class="tab-content">
                    <!-- Tab Posts -->
                    <div class="tab-pane animated active fadeInRight" id="gallary">
                            ...
                            <div class="col-lg-12 col-xl-11 center-block">
                                <div class="card grid-margin">
                                    <div class="card1-body">
                                        ...
                                        <div class="header">
                                            <h5 class="h5">
                                                แมวไม่มีเจ้าของทั้งหมดในแผนที่
                                            </h5>
                                        </div>
                                        <div class="body">
