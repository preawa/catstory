@extends('author.customers.layout')
@section('content')
    <div class="row">
    ...
    <table class="table table-bordered">
        ...
        @foreach ($customers as $customer)
            <tr id="customer_id_{{ $customer->id }}">
                ...
                <td>
                    <form action="{{ route('author.customers.destroy', $customer->id) }}" method="POST">
                        <a class="btn btn-info" id="show-customer" data-toggle="modal"
                            data-id="{{ $customer->id }}">Show</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="custForm" action="{{ route('author.customers.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                ...
                                <a href="{{ route('author.customers.index') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <div class="col-xs-10 col-sm-10 col-md-10 ">
                            @if (isset($customer->name))
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2" style="text-align: right "><a href="{{ route('author.customers.index') }}"
...
<script>
    ...
    function validate() {
        if (document.custForm.name.value != '' && document.custForm.email.value != '' && document.custForm.address
            .value != '')
