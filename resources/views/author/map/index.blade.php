...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            <a class="btn btn-primary waves-effect" href="{{ route('author.map.create') }}">
                                    ...
                                    @foreach($maps as $key=>$map)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('author.map.show',$map->id) }}" class="btn btn-success waves-effect">
                                                    <i class="material-icons">visibility</i>
                                                </a>
                                                <button class="btn btn-danger waves-effect" type="button" onclick="deleteMap({{ $map->id }})">
                                                    <i class="material-icons">delete</i>
                                                </button>
                                                <form id="delete-form-{{ $map->id }}" action="{{ route('author.map.destroy',$map->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
